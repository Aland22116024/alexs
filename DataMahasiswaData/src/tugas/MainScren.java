...
public class MainScren extends JFrame {

    private static final String URL = "jdbc:mysql://localhost:3306/alexs";
    ...
    public static void main(String[] args){
       MainScren mainScren = new MainScren();
       mainScren.setVisible(true);
    }
}
